...
<head>
	<meta charset="UTF-8">
	<title>Administracion de Publicidad</title>
</head>
<body>
</body>
</html>
...
echo "<html><center>";
echo "<form action='../Controlador/TPublcidad.php' method='post'>";
//echo "<table class='gridtable' type='text/css' href='../Utilitarios/Maqueta.css'>";
echo "<table>";
echo "<tr><th bgcolor='#6699FF'>ID PUBLICIDAD</th><th bgcolor='#6699FF'>NOMBRE</th>
          <th bgcolor='#6699FF'>DESCRIPCION</th><th bgcolor='#6699FF'>TIEMPO DURACION</th></tr>";
//LLENAR TABLA
...
//cuadro de captura de datos
  echo "<tr>";
  echo "<td><input type=text name=idPubl></td>";
  echo "<td><input type=text name=nombre></td>";
  echo "<td><input type=text name=desc></td>";
  echo "<td><input type=text name=tEstimado></td>";
  echo "</tr></table>";  
